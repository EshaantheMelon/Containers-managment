...
@section('title', trans('port.create'))

@section('head')

    <h1>
        {{ trans('utils.menu.m_ports') }}
        <small>{!! trans('port.create') !!}</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{!! trans('port.create') !!}</li>
    </ol>
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">{!! trans('port.create') !!}</h3>
    ...
    <div class="box-body">
        ...
        {{ Form::open(array('url' => 'admin/ports')) }}
