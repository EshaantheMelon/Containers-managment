...
@section('title', trans('depot.create'))

@section('head')

    <h1>
        {{ trans('utils.menu.m_depots') }}
        <small>{!! trans('depot.create') !!}</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{!! trans('depot.create') !!}</li>
    </ol>
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">{!! trans('depot.create') !!}</h3>
    ...
    <div class="box-body">
        ...
        {{ Form::open(array('url' => 'admin/depots')) }}
