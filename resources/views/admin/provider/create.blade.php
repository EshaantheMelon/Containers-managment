...
@section('title', trans('provider.create'))

@section('head')

    <h1>
        {{ trans('utils.menu.m_partners') }}
        <small>{!! trans('provider.create') !!}</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{!! trans('provider.create') !!}</li>
    </ol>
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">{!! trans('provider.create') !!}</h3>
    </div>
    <div class="box-body">
        ...
        {{ Form::open(array('url' => 'admin/providers')) }}
