...
@section('title', trans('quotation.update'))

@section('head')

    <h1>
        {{ trans('utils.menu.m_quotations') }}
        <small>{!! trans('quotation.update') !!}</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{!! trans('quotation.update') !!}</li>
    </ol>
...
<div class="box">
    ...
    <div class="box-body">
        ...
        {{ Form::model($quotation, ['route' => ['admin.quotations.update', $quotation->id], 'method' => 'PUT']) }}
