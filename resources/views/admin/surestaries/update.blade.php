...
@section('title', trans('surestaries.update'))
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">{!! trans('surestaries.update') !!}</h3>
    ...
    <div class="box-body">
        ...
        {{ Form::model($surestaries,['route' => ['admin.surestaries.update', $surestaries->id], 'method' => 'PUT']) }}
