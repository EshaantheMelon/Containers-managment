...
@section('title', trans('contract.create'))

@section('head')

    <h1>
        {{ trans('utils.menu.m_contracts') }}
        <small>{!! trans('contract.create') !!}</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{!! trans('contract.create') !!}</li>
    </ol>
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">{!! trans('contract.create') !!}</h3>
