            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
                ...
                <fieldset>
                    ...
                    <div class="input-prepend">
                        <label class="remember" for="remember"><input type="checkbox" id="remember"> {{ trans('auth.remember_me') }}</label>
                        <a href="{{ url('/password/reset') }}">{{ trans('auth.forgot') }}</a>
                    </div>
                    <div class="clearfix"></div>

                    <p class="center col-md-5">
                        <button type="submit" class="btn btn-primary">{{ trans('auth.loginBtn') }}</button>
